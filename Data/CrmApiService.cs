...
namespace Mantis.Data
{
    public class CrmApiService
    {
        ...
        {
            var request = new HttpRequestMessage(HttpMethod.Post, "https://api.myappliedproducts.com/v1/auth/connect/token");
        ...
        {
            var request = new HttpRequestMessage(HttpMethod.Get, $"https://api.myappliedproducts.com/crm/v1/clients?lookupCode={lookupCode}");
        ...
        {
            var request = new HttpRequestMessage(HttpMethod.Get, $"https://api.myappliedproducts.com/policy/v1/clients/{clientId}/policies");
            request.Headers.Authorization = new AuthenticationHeaderValue("Bearer", accessToken);
            var response = await _httpClient.SendAsync(request);
            response.EnsureSuccessStatusCode();
        ...
        {
            var request = new HttpRequestMessage(HttpMethod.Get, $"https://api.myappliedproducts.com/policy/v1/policies/{ePolicyId}/lines");
